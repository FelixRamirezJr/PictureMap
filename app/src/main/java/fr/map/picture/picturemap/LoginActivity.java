...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static String login_url = "https://picture-map-api.herokuapp.com/users/sign_in_or_create.json";
...
//        }
        ...
        if (cancel) {
            ...
            // Populate JSON data to send to the server
...
//            String url = "https://picture-map-api.herokuapp.com/sign_in_or_create";
